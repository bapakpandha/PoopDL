                ...
                <div className="wrapper overflow-hidden flex max-h-96 flex-row items-center justify-between px-4">
                    ...
                    <div className="flex flex-1 flex-col">
                        ...
                        <div className=" ml-4 mt-3 flex flex-col">
                            <div className="flex items-center text-center">
                                <svg className="mx-1.5 flex h-3 w-3 items-center justify-center" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g id="SVGRepo_iconCarrier"><path d="M12 7V12L14.5 10.5M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g>
                                </svg>
                        ...
                        <div className="flex flex-col gap-3 justify-items-start ml-6 mt-4 sm:flex-row">
                            ...
                            <button className="rounded border border-red-600 px-3 py-1.5 sm:text-sm text-xs font-semibold text-red-600 hover:bg-red-100">Get Thumbnail</button>
                        </div>
                    </div>
                </div>
            ) : (
